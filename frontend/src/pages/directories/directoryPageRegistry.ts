...
const BankStatementPage = React.lazy(() => import('./customDirectoryPages/bank-statement/BankStatement'));
...
export function getDirectoryPageComponent(name?: string): React.LazyExoticComponent<ComponentType<object>> {
